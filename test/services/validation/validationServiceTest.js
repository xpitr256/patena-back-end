...
describe("Validation service test ", () => {
  ...
  describe("Contact form validation ", () => {
    ...
    it("Given empty name and mail, message less than 50 caracters  it should return false", () => {
      assert.isFalse(
        service.isValidContactData(
          "",
          "",
          "hola como estas? quiero que ande el patena de una vez por todas. cuando puede estar listo...desde ya muchas gracias"
        )
      );
    });
